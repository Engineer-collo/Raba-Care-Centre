...
export default function Sustainability() {
  return (
    <section className="ml-12 mr-12 bg-white rounded-2xl shadow-md border-l-4 border-t-4 border-red-900 p-8 my-10">
      <h2 className=" text-center text-2xl font-bold text-red-900 mb-4">Our Sustainability Commitment</h2>
      <p className="text-gray-700 mb-6">
        At <span className="text-center text-amber-500 font-semibold">Rabacare</span>, we believe technology should care
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {/* Environmental */}
        <div className="border-t-4 border-l-4 border-amber-500 p-4 rounded-xl bg-red-50 shadow-sm flex flex-col items-center text-center">
          <img
