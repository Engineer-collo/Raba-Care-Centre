      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-3">
          {list.map((t, i) => (
            <article
              key={i}
              className="bg-white p-6 rounded-2xl shadow-md border-t-4 border-amber-400 flex flex-col items-start"
            >
        ...
        <p className="text-center mt-8 text-sm text-gray-500">Want to add your testimonial? Reach out — we'd love to feature you.</p>
      </div>
    </section>
  );
}
...
1. Save images to your public folder: /public/testimonials/person1.jpg etc.
2. Import and use:
...
const data = [{ name, image, message }, ...];
<Testimonials testimonials={data} />

Notes:
- The component uses bg-[#fff5f6] to approximate "maroo-50" and Tailwind's amber-400 for accents.
