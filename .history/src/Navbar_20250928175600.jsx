    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-[#581616] text-white shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          {/* 👇 Use React Router Link for profile */}
          <Link
            to="/profile"
      ...
      {isOpen && (
        <nav className="md:hidden bg-[#581616] px-6 py-4 flex flex-col items-center gap-4">
          <a href="#home" onClick={handleLinkClick} className="hover:text-amber-400">
            Home
          </a>
          <a href="#about" onClick={handleLinkClick} className="hover:text-amber-400">
            About
          </a>
          <a href="#services" onClick={handleLinkClick} className="hover:text-amber-400">
            Services
          </a>
          <a href="#gallery" onClick={handleLinkClick} className="hover:text-amber-400">
            Gallery
          </a>
          <a href="#contact" onClick={handleLinkClick} className="hover:text-amber-400">
            Contact
          </a>
