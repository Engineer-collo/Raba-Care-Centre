...
const WhatsAppButton = () => {
  const phoneNumber = '2547757855508'; // Replace with your actual phone number (in international format)
  const message = 'Hello! I visited your site and would like to chat.';
