...
const FeedbackForm = () => {
  ...
  return (
    <div id="feedback" className="bg-white shadow-lg rounded-2xl p-6 md:p-10 mb-8 max-w-3xl mx-auto">
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-center">
        We Value Your Feedback!
      </h2>
      <p className="text-gray-600 text-base md:text-lg leading-relaxed text-center mb-2">
