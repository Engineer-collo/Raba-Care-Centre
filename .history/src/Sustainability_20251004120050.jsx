...
export default function Sustainability() {
  return (
    <section className="bg-white rounded-2xl shadow-md border-l-4 border-t-4 border-red-900 p-8 my-10">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="p-4 rounded-xl bg-red-50 shadow-sm flex flex-col items-center text-center">
          <img
            src="https://undraw.co/api/illustrations/environment_eco.svg"
            alt="Eco friendly"
        ...
        <div className="p-4 rounded-xl bg-red-50 shadow-sm flex flex-col items-center text-center">
          <img
            src="https://undraw.co/api/illustrations/teamwork_inclusive.svg"
        ...
        <div className="p-4 rounded-xl bg-red-50 shadow-sm flex flex-col items-center text-center">
          <img
            src="https://undraw.co/api/illustrations/data_growth.svg"
