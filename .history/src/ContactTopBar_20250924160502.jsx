...
const TopBar = () => {
  return (
    <div className="w-full bg-amber-600 text-white text-xs md:text-sm lg:text-base px-4 py-2 flex flex-col md:flex-row md:justify-between md:items-center space-y-2 md:space-y-0">
      {/* Left side: Phone & Email */}
      <div className="flex justify-center md:justify-start items-center space-x-4">
        <a
          href="tel:+254700000000"
