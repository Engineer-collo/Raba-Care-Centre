...
export default function Milestones() {
  return (
    <div className="mt-12 bg-white p-8 rounded-2xl shadow-lg border-t-8 border-t-8 border-red-900 max-w-6xl mx-auto">
      <h2 className="text-3xl font-bold text-red-900 mb-10 text-center">
        Rabacare Journey
      </h2>

      <div className="relative flex items-start justify-between border-t-4 border-amber-500 pt-10">
        {milestones.map((m, i) => (
          <motion.div
            key={i}
