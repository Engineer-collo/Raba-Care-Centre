...
const TeamAdmin = () => {
  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-900 dark:text-white rounded-xl shadow-md w-full max-w-4xl mx-auto">
      ...
      <div className="space-y-2 mb-6">
        <input
          ...
          className="border px-3 py-2 rounded w-full dark:bg-gray-800 dark:border-gray-600"
        />
        <input
          type="text"
          placeholder="Name"
      ...
      <ul className="space-y-4">
        {teams.map(team => (
          <li key={team.id} className="flex flex-col gap-2 border p-4 rounded shadow-sm dark:border-gray-700">
            {editingId === team.id ? (
              <>
                <input
                  type="text"
            ...
            >
              ...
              <>
                ...
                {team.picture_url && (
                  <img src={team.picture_url} alt={team.name} className="w-48 h-auto object-cover rounded" />
                )}
                {/* <p className="text-sm text-gray-500 dark:text-gray-400">{team.intro_text}</p> */}
              </>
            )}
          </li>
        ))}
