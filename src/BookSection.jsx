...
const BooksSection = () => {
  return (
    <section
      id="products"
      className="scroll-mt-20 py-12 px-6 max-w-6xl mx-auto text-center bg-gray-50 dark:bg-gray-900"
    >
      <h2 className="text-4xl font-bold mb-12 text-gray-800 dark:text-white">
        Books by Redempta Kanja
      </h2>
      ...
      <div className="grid gap-10 md:grid-cols-3 sm:grid-cols-2 justify-items-center">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow w-full max-w-sm text-left">
          ...
          <h4 className="font-semibold text-xl mb-3 text-gray-800 dark:text-white">
            Find Adopt Live Your Purpose
          </h4>
          <div className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed max-h-[360px] overflow-y-auto pr-1">
            <p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow w-full max-w-sm text-left">
          ...
          <div className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed max-h-[360px] overflow-y-auto pr-1">
            <p>
              A bold invitation to rise above fear, failures, and limits — "Taking Charge" helps you discover your
              authentic identity, rewrite your story, and ignite the gifts within you. You’ll learn how to:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-600 dark:text-gray-400">
            ...
            <p className="mt-3">Step into your greatness — the world is waiting.</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow w-full max-w-sm text-left">
          ...
          <div className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed max-h-[360px] overflow-y-auto pr-1">
            <p>
              A modern-day book of proverbs for the next generation. Inspired by a mother’s love, it shares biblical wisdom
              to shape young lives. Children and parents alike will:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-600 dark:text-gray-400">
